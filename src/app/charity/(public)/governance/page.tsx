                  ...
                  {vote.hasVoted ? (
                    ...
                    <div className="flex gap-3">
                      <ComingSoonOverlay action="Vote on milestone">
                        <button className="flex-1 py-3.5 sm:py-3 px-8 bg-[#0EA5E9] rounded-full text-[14px] font-semibold text-white">Approve</button>
                      </ComingSoonOverlay>
                      <ComingSoonOverlay action="Vote on milestone">
                        <button className="flex-1 py-3.5 sm:py-3 px-8 bg-[#F8FAFC] rounded-full text-[14px] font-semibold text-[#0F172A]">Reject</button>
                      </ComingSoonOverlay>
                      <ComingSoonOverlay action="Vote on milestone">
                        <button className="flex-1 py-3.5 sm:py-3 px-8 bg-[#F8FAFC] rounded-full text-[14px] font-medium text-[#94A3B8]">Abstain</button>
                      </ComingSoonOverlay>
                    </div>
                  )}
                </div>
